 ...
 */
@FragmentScope
public class MainUsercenterModel extends BaseModel implements MainUsercenterContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public MainUsercenterModel(IRepositoryManager repositoryManager) {
