 ...
 */
@FragmentScope
public class MainRecommendModel extends BaseModel implements MainRecommendContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public MainRecommendModel(IRepositoryManager repositoryManager) {
